...
import static CAPA_PRESENTACION.EMPLEADO.PNLRegistrarProducto.fechaselect;
 ...
 * @version Beta
 */
public class PNLFechaRegistrar extends javax.swing.JPanel {

    /**
     * Creates new form PNLFechaRegistrar
     */
    // <editor-fold defaultstate="collapsed" desc="Constructor">
    public PNLFechaRegistrar() {
    ...
    public static void MarcarFecha(String fecha){
        ...
        String months[] = {"January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"};
        Date date = new Date(fechaA[2]+"-" + months[me] + "-" + fechaA[0]);
        String dat= "" + date.getDate();
        iniciarCalendario(me,Año);
        int C = modeloTabla.getColumnCount();
        int R = modeloTabla.getRowCount();
        for (int r = 0; r < R; r++) {
            for (int c = 0; c < C; c++) {
                ...
                if (valor.equals("" + dat)) {
                    ...
                    lblfecha.setText(año+"-"+meses[me]+"-"+fechaA[2]);
                }
            }
        }
