...
public class FRMRegistrar extends javax.swing.JFrame {
    ...
    private void btnEntrarAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarAdminActionPerformed
        ...
        String usuario=TIPOS.clearEspacios(txtLoginAdmin.getText());
        String pswEmpleado;
        char psw[]=pwdLoginAdmin.getPassword();
        pswEmpleado=new String(psw);
        if(usuario.equals("Admin")){
            if(CAPA_PRESENTACION.FRMLogin.login.ChecarLogin(usuario, pswEmpleado)!=0){
                JOptionPane.showMessageDialog(this, "Entrando...");
                this.dispose();
                FRMMenuAdmin fRMRegistrarEmpleado=new FRMMenuAdmin();
                fRMRegistrarEmpleado.setVisible(true);
            }else{
                JOptionPane.showMessageDialog(this, "Error de usuario o contraseña");
            }
        }else{
            JOptionPane.showMessageDialog(this, "El usuario no tiene permisos para registrar");
        }
    ...
    private void pwdLoginAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pwdLoginAdminActionPerformed
        // TODO add your handling code here:
        String usuario=txtLoginAdmin.getText();
        String pswEmpleado;
        char psw[]=pwdLoginAdmin.getPassword();
        pswEmpleado=new String(psw);
        if(txtLoginAdmin.getText().equals("Admin")){
            if(CAPA_PRESENTACION.FRMLogin.login.ChecarLogin(usuario, pswEmpleado)!=0){
                JOptionPane.showMessageDialog(this, "Entrando...");
                this.dispose();
                FRMMenuAdmin frmRegistrarEmpleado=new FRMMenuAdmin();
